...
class UNet(nn.Module):
    ...
    ## EDITs ###
    def refit_block(self, in_channels, out_channels, kernel_size=5):
        '''
    ...
    def __init__(self, in_channel, out_channel):
        ...
        # Decode
        self.conv_decode3 = self.expansive_block(256, 192 ,128) ## before (512, 256, 128)
        self.conv_decode2 = self.expansive_block(128, 96, 64) ## before (256, 128, 64)
        self.final_layer = self.final_block(64, 32, out_channel) ## before 128, 64, out_channel
        ### EDIT ###
        self.refit_layer = self.refit_block(in_channels = 1, out_channels = 1)
